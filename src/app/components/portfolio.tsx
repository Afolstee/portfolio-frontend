...
const Portfolio = () => {
  ...
  const getDefaultSkills = () => [
    ...
    { name: "Backend", icon: <Database className="w-6 h-6" />, techs: ["Python", "FastAPI", "Node.js", "PostgreSQL"] },
    { name: "Tools", icon: <Code className="w-6 h-6" />, techs: ["Git", "Docker", "AWS", "Vercel"] }
  ];
    ...
    try {
      await fetch(`${API_BASE}/api/projects/${projectId}/view`, {
        ...
        body: JSON.stringify({
          ...
          user_ip: null // Will be handled by backend
        })
      });
    } catch (error) {
              ...
              {projects.map((project, index) => (
                <div key={project.id || index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-purple-400/50 transition-all duration-300 hover:scale-105">
                  <div className="flex items-center mb-4">
                    <div className="text-4xl mr-4">{project.image_emoji || project.image}</div>
                    <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(project.tech_stack || project.tech || []).map((tech, idx) => (
        ...
        <section className="min-h-screen flex items-center justify-center px-4 pt-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-8 mb-12">
              ...
              <a href="https://www.linkedin.com/in/temilade-afolabi-aa7b7430b/" className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg transition-colors">
                <Linkedin className="w-5 h-5" />
                <span>LinkedIn</span>
              </a>
              <a href="https://github.com/Afolstee" className="flex items-center space-x-2 bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-lg transition-colors">
