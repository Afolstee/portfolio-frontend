...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A modern task management application with drag-and-drop functionality, team collaboration features, and real-time updates.",
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-300 leading-relaxed">
                  ...
                  work, and has evolved into a deep understanding of both
                  frontend and backend development. I'm particularly interested
                  in fintech, market analysis, and creating user-friendly
                  interfaces.
                </p>
                ...
                >
                  ...
                  <div className="space-y-2">
                    {skill.techs.map((tech, idx) => (
                      <div
                        key={idx}
                        className="text-sm text-slate-300 bg-slate-700/30 px-3 py-1 rounded"
                      >
                        {tech}
                      </div>
                    ))}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-8 mb-12">
              <a
                ...
                className="flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 px-6 py-3 rounded-lg transition-colors"
              >
